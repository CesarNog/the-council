...
const S = {
  ...
  reveal_all: { en: "Reveal all →", pt: "Revelar tudo →", es: "Revelar todo →", zh: "全部显示 →" },
  ...
  share_redacted_question: { en: "A personal decision", pt: "Uma decisão pessoal", es: "Una decisión personal", zh: "一个个人决定" },
  share_preview_title: { en: "Before you share", pt: "Antes de compartilhar", es: "Antes de compartir", zh: "分享之前" },
  share_preview_explain: { en: "Anyone with this link can see the full debate below, including your original question.", pt: "Qualquer pessoa com este link pode ver o debate completo abaixo, incluindo sua pergunta original.", es: "Cualquier persona con este enlace puede ver el debate completo a continuación, incluyendo tu pregunta original.", zh: "任何拥有此链接的人都可以看到下方的完整辩论，包括你的原始问题。" },
  share_preview_redact_toggle: { en: "Redact personal details", pt: "Ocultar detalhes pessoais", es: "Ocultar detalles personales", zh: "隐去个人细节" },
  share_preview_redact_hint: { en: "Only changes this shared text/image — the link itself still opens the full debate page.", pt: "Isso muda apenas este texto/imagem compartilhado — o link em si ainda abre a página completa do debate.", es: "Esto solo cambia este texto/imagen compartido — el enlace en sí todavía abre la página completa del debate.", zh: "这只会改变此次分享的文字/图片——链接本身仍会打开完整的辩论页面。" },
  share_preview_confirm: { en: "Continue", pt: "Continuar", es: "Continuar", zh: "继续" },
  share_preview_cancel: { en: "Cancel", pt: "Cancelar", es: "Cancelar", zh: "取消" },
  ...
  // These four fire whenever "depends" votes are numerically significant —
  // never collapse a three-way split into a two-number score that erases them.
  divided_tied: { en: (y, n, d) => `The Council is divided — ${y} yes, ${n} no, ${d} depends.`, pt: (y, n, d) => `O Conselho está dividido — ${y} sim, ${n} não, ${d} depende.`, es: (y, n, d) => `El Consejo está dividido — ${y} sí, ${n} no, ${d} depende.`, zh: (y, n, d) => `议会存在分歧 — 赞成${y}，反对${n}，待定${d}。` },
  divided_leans_yes: { en: (y, d, n) => `The Council is divided. Yes leans ahead — ${y} yes, ${d} depends, ${n} no.`, pt: (y, d, n) => `O Conselho está dividido. O sim lidera — ${y} sim, ${d} depende, ${n} não.`, es: (y, d, n) => `El Consejo está dividido. El sí lidera — ${y} sí, ${d} depende, ${n} no.`, zh: (y, d, n) => `议会存在分歧，赞成略占上风 — 赞成${y}，待定${d}，反对${n}。` },
  divided_leans_no: { en: (n, d, y) => `The Council is divided. No leans ahead — ${n} no, ${d} depends, ${y} yes.`, pt: (n, d, y) => `O Conselho está dividido. O não lidera — ${n} não, ${d} depende, ${y} sim.`, es: (n, d, y) => `El Consejo está dividido. El no lidera — ${n} no, ${d} depende, ${y} sí.`, zh: (n, d, y) => `议会存在分歧，反对略占上风 — 反对${n}，待定${d}，赞成${y}。` },
  divided_depends_lead: { en: (d, y, n) => `The Council is divided. Most say it depends — ${d} depends, ${y} yes, ${n} no.`, pt: (d, y, n) => `O Conselho está dividido. A maioria diz que depende — ${d} depende, ${y} sim, ${n} não.`, es: (d, y, n) => `El Consejo está dividido. La mayoría dice que depende — ${d} depende, ${y} sí, ${n} no.`, zh: (d, y, n) => `议会存在分歧，多数认为视情况而定 — 待定${d}，赞成${y}，反对${n}。` },
  ...
  chapter_synthesis: { en: "VI · What This Rests On", pt: "VI · Sobre O Que Isso Se Apoia", es: "VI · Sobre Qué Se Apoya", zh: "六 · 这个结论建立在什么之上" },
  chapter_protocol: { en: "VII · The Decision Protocol", pt: "VII · O Protocolo de Decisão", es: "VII · El Protocolo de Decisión", zh: "七 · 决策方案" },
  chapter_share: { en: "VIII · Share", pt: "VIII · Compartilhar", es: "VIII · Compartir", zh: "八 · 分享" },
  vote_condition_label: { en: "Would flip if", pt: "Mudaria se", es: "Cambiaría si", zh: "转变条件" },
  synthesis_dissent_label: { en: "Central disagreement", pt: "Divergência central", es: "Desacuerdo central", zh: "核心分歧" },
  synthesis_assumptions_label: { en: "Assuming", pt: "Partindo do princípio de que", es: "Suponiendo que", zh: "前提假设" },
  synthesis_unknowns_label: { en: "Still unknown", pt: "Ainda desconhecido", es: "Aún desconocido", zh: "尚不清楚" },
  synthesis_confidence_label: { en: "Council's confidence", pt: "Confiança do Conselho", es: "Confianza del Consejo", zh: "议会的把握程度" },
  confidence_low: { en: "Low", pt: "Baixa", es: "Baja", zh: "低" },
  confidence_medium: { en: "Medium", pt: "Média", es: "Media", zh: "中" },
  confidence_high: { en: "High", pt: "Alta", es: "Alta", zh: "高" },
  protocol_next48_label: { en: "Next 48 hours", pt: "Próximas 48 horas", es: "Próximas 48 horas", zh: "未来48小时" },
  protocol_experiment_label: { en: "Before committing", pt: "Antes de se comprometer", es: "Antes de comprometerte", zh: "在做出承诺之前" },
  protocol_checkpoint_label: { en: "Decision checkpoint", pt: "Ponto de checagem", es: "Punto de control", zh: "决策检查点" },
  protocol_stop_label: { en: "Stop condition", pt: "Condição de parada", es: "Condición de parada", zh: "停止条件" },
  stage_responds: {
    en: name => `${name} speaks`,
  ...
  // Deep Council — optional structured intake (progressive disclosure past the quick path)
  onb_depth_q: { en: "How deep should this go?", pt: "Até que profundidade isso deve ir?", es: "¿Qué tan profundo debe llegar esto?", zh: "这次要深入到什么程度？" },
  onb_depth_hint: { en: "More context sharpens the debate. You can always skip ahead.", pt: "Mais contexto afia o debate. Você sempre pode pular adiante.", es: "Más contexto agudiza el debate. Siempre puedes saltar adelante.", zh: "更多背景会让辩论更加犀利，你随时可以跳过。" },
  onb_depth_quick: { en: "Quick Council", pt: "Conselho Rápido", es: "Consejo Rápido", zh: "快速议会" },
  onb_depth_quick_sub: { en: "Convene now with what you've shared.", pt: "Convoque agora com o que você já compartilhou.", es: "Convoca ahora con lo que ya compartiste.", zh: "以你已分享的内容立即召开。" },
  onb_depth_deep: { en: "Deep Council", pt: "Conselho Profundo", es: "Consejo Profundo", zh: "深度议会" },
  onb_depth_deep_sub: { en: "Three short screens for a sharper verdict.", pt: "Três telas curtas para um veredito mais afiado.", es: "Tres pantallas breves para un veredicto más agudo.", zh: "三个简短的步骤，换来更精准的裁决。" },
  onb_deep_progress_1: { en: "The deeper rite · I", pt: "O ritual profundo · I", es: "El rito profundo · I", zh: "深度仪式 · 一" },
  onb_deep_progress_2: { en: "The deeper rite · II", pt: "O ritual profundo · II", es: "El rito profundo · II", zh: "深度仪式 · 二" },
  onb_deep_progress_3: { en: "The deeper rite · III", pt: "O ritual profundo · III", es: "El rito profundo · III", zh: "深度仪式 · 三" },
  onb_skip_to_quick: { en: "Skip to Quick Council →", pt: "Pular para o Conselho Rápido →", es: "Saltar al Consejo Rápido →", zh: "跳到快速议会 →" },
  onb_options_q: { en: "What exactly are you choosing between?", pt: "Entre o quê, exatamente, você está escolhendo?", es: "¿Entre qué estás eligiendo, exactamente?", zh: "你到底是在哪两者之间做选择？" },
  onb_option_a_placeholder: { en: "The first path", pt: "O primeiro caminho", es: "El primer camino", zh: "第一条路" },
  onb_option_b_placeholder: { en: "The second path", pt: "O segundo caminho", es: "El segundo camino", zh: "第二条路" },
  onb_constraints_q: { en: "Any hard constraints or non-negotiables?", pt: "Alguma restrição rígida ou inegociável?", es: "¿Alguna restricción rígida o innegociable?", zh: "有什么硬性限制或不可妥协的条件吗？" },
  onb_constraints_placeholder: { en: "e.g. Can't relocate before next year", pt: "ex: Não posso me mudar antes do ano que vem", es: "ej: No puedo mudarme antes del próximo año", zh: "例：明年之前不能搬家" },
  onb_deadline_q: { en: "Is there a deadline?", pt: "Existe um prazo?", es: "¿Hay una fecha límite?", zh: "有截止日期吗？" },
  onb_deadline_week: { en: "This week", pt: "Esta semana", es: "Esta semana", zh: "本周" },
  onb_deadline_month: { en: "This month", pt: "Este mês", es: "Este mes", zh: "本月" },
  onb_deadline_months: { en: "A few months", pt: "Alguns meses", es: "Unos meses", zh: "几个月内" },
  onb_deadline_none: { en: "No deadline", pt: "Sem prazo", es: "Sin fecha límite", zh: "没有截止日期" },
  onb_reversible_q: { en: "Can this decision be undone?", pt: "Essa decisão pode ser desfeita?", es: "¿Se puede deshacer esta decisión?", zh: "这个决定可以撤销吗？" },
  onb_reversible_easy: { en: "Easily", pt: "Facilmente", es: "Fácilmente", zh: "很容易" },
  onb_reversible_hard: { en: "With difficulty", pt: "Com dificuldade", es: "Con dificultad", zh: "有难度" },
  onb_reversible_permanent: { en: "Not really", pt: "Não realmente", es: "No realmente", zh: "基本不能" },
  onb_cost_waiting_q: { en: "What's the cost of waiting to decide?", pt: "Qual é o custo de esperar para decidir?", es: "¿Cuál es el costo de esperar para decidir?", zh: "拖延决定的代价是什么？" },
  onb_cost_low: { en: "Low", pt: "Baixo", es: "Bajo", zh: "低" },
  onb_cost_medium: { en: "Medium", pt: "Médio", es: "Medio", zh: "中" },
  onb_cost_high: { en: "High", pt: "Alto", es: "Alto", zh: "高" },
  onb_success_q: { en: "What does success look like a year from now?", pt: "Como é o sucesso daqui a um ano?", es: "¿Cómo es el éxito dentro de un año?", zh: "一年后，成功是什么样子？" },
  onb_success_placeholder: { en: "Paint the picture, briefly", pt: "Descreva brevemente essa imagem", es: "Describe brevemente esa imagen", zh: "简单描绘一下这幅画面" },
  onb_known_q: { en: "What do you already know for certain?", pt: "O que você já sabe com certeza?", es: "¿Qué sabes ya con certeza?", zh: "你已经确切知道什么？" },
  onb_known_placeholder: { en: "The facts you're sure of", pt: "Os fatos dos quais você tem certeza", es: "Los hechos de los que estás seguro", zh: "你确信的事实" },
  onb_unknown_q: { en: "What's still unknown?", pt: "O que ainda é desconhecido?", es: "¿Qué sigue siendo desconocido?", zh: "还有什么是未知的？" },
  onb_unknown_placeholder: { en: "The gaps that worry you most", pt: "As lacunas que mais te preocupam", es: "Los vacíos que más te preocupan", zh: "最让你担心的空白" },
  onb_convene_deep: { en: "Convene the Council", pt: "Convocar o Conselho", es: "Convocar al Consejo", zh: "召开议会" },
