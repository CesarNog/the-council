...
const S = {
  ...
  share_link_unavailable: { en: "This is an offline demo — there's no link to share yet. Ask a real question to get a shareable verdict.", pt: "Este é um demo offline — ainda não há um link para compartilhar. Faça uma pergunta real para receber um veredito compartilhável.", es: "Esta es una demo sin conexión — todavía no hay un enlace para compartir. Haz una pregunta real para recibir un veredicto compartible.", zh: "这是离线演示——目前还没有可分享的链接。提出一个真实的问题，即可获得可分享的裁决。" },
